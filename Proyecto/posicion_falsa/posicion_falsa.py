...
# 5. Entrenar el modelo con el Método de la Posición Falsa
...
plt.title('Curva ROC para Deserción de Estudiantes (Método de la Posición Falsa)')
...
plt.title("Distribución de Probabilidades de Deserción (Método de la Posición Falsa)")
