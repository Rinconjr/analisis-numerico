...
# 5. Entrenar el modelo con el Método de la Bisección usando solo "Horas_estudio_por_semana"
...
plt.title('Curva ROC para Deserción de Estudiantes (Horas de Estudio - Bisección)')
...
plt.title("Distribución de Probabilidades de Deserción (Horas de Estudio - Bisección)")
